...
class SistemaMultiagenteDocuBot:
    ...
    def _estado_sistema_tool(self, dummy: str = "") -> str:
        ...
        return f"{'✅' if self.documentos_cargados else '❌'} Cargado: {len(self.chunks)} chunks"
    ...
    def cargar_documentos(self, tamano_chunk: int = 400) -> Dict:
        ...
        """
        print(f"\n{'='*60}")
        print("📂 INICIANDO FLUJO DE CARGA MULTIAGENTE")
        print(f"{'='*60}\n")
    ...
    def procesar_pregunta(self, pregunta: str, top_k: int = 3) -> str:
        ...
        if not self.documentos_cargados:
            return "❌ Sistema no inicializado. Carga documentos primero."
...
def crear_sistema(carpeta="documentos"):
    ...
    """
    return SistemaMultiagenteDocuBot(carpeta)