...
git clone <tu-repo> cd studentbot
...
Cargar documentos
POST /api/cargar { "carpeta": "documentos", "tamano_chunk": 400 }
Hacer una pregunta
POST /api/preguntar { "pregunta": "¿Qué es el emprendimiento?", "top_k": 3, "usar_gemini": true }
Estado del sistema
POST /api/resumen { "documento": "archivo.pdf" }
Modo Interfaz Web
cd frontend python -m http.server 8000
Abrir en: http://localhost:8000

Modo Script
from sistema_langchain import SistemaMultiagenteStudentBot sistema = SistemaMultiagenteStudentBot( carpeta_documentos="documentos", gemini_api_key="tu_key" ) resultado = sistema.cargar_documentos(tamano_chunk=400) print(resultado) respuesta = sistema.procesar_pregunta("¿Qué es el emprendimiento?") print(respuesta)
